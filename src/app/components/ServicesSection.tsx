    ...
    return (
      <motion.div
        ...
        style={{
          background:
            activeService === i
              ? `linear-gradient(135deg, ${service.accent}0d, rgba(18,18,18,0.95))`
              : "rgba(18,18,18,0.8)",
          borderColor:
            activeService === i
              ? `${service.accent}44`
          ...
          boxShadow:
            activeService === i
              ? `0 20px 60px rgba(0,0,0,0.4), 0 0 40px ${service.accent}1a`
              : "none",
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            opacity: activeService === i ? 0.1 : 0.03,
          }}
        />
        ...
        <motion.div
          ...
          animate={{
            rotate: activeService === i ? [0, -5, 5, 0] : 0,
          }}
          transition={{
            duration: 0.4,
          }}
